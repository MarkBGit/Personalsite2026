  ...
  return (
    <section className="min-h-screen py-18 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Mobile: Concert Set List */}
        <div className="md:hidden">
          {/* Set List Header */}
          <div className="text-center mb-8 pb-4 border-b-2 border-[#CC5500]/30">
            <p 
          ...
          <div className="space-y-4">
            {jobs.map((job, index) => (
              <motion.div
                key={job.id}
                className="bg-[#1a1a1a] border border-white/20 rounded-lg overflow-hidden"
                initial={false}
                animate={{ 
                  borderColor: selectedJob === job.id ? "#CC5500" : "rgba(255, 255, 255, 0.2)",
                }}
              >
                <div
                ...
                >
                  {/* Track Number */}
                  <div 
                    className="text-2xl text-[#5A7D9A] flex-shrink-0 w-8"
                  ...
                  <motion.div
                    ...
                    className="flex-shrink-0 text-[#CC5500]"
                  >
                    <svg
                      width="20"
                      height="20"
        ...
        {/* Liner Notes (Job Details) - Desktop Only */}
        <AnimatePresence mode="wait">
          {selectedJob && (
            <motion.div
              ...
              className="hidden md:block mt-12 bg-[#1a1a1a] border border-[#CC5500]/30 rounded p-6 max-w-3xl mx-auto"
            >
              <h3
